...
class AllApplications(models.Model):
    ...
    extra_insurance = models.ForeignKey(ClientExtraInsurance, on_delete=models.CASCADE)  # Связь с таблицей ExtraInsurance
...
class UserProfile(models.Model):
    ...
    dealership_manager = models.ManyToManyField(Dealership, blank=True, related_name='managed_profiles', verbose_name="Дилерский центр")
    active_dealership = models.ForeignKey(Dealership, null=True, blank=True, on_delete=models.SET_NULL, related_name='active_profiles')
