...
from credit_v0.tests.conftest import PASS_ALL_ACC, BASE_URL

load_dotenv()


# pytest -s credit_v0/tests/playwright/test_pw.py::TestUsers::test_create_delete_user
...
class TestQuestionnaireAndUploadClientFiles:
    ...
    PATH_TO_FIRST_OK_FILE = 'credit_v0/tests/test_files/ok_size_1.jpg'
    PATH_TO_SECOND_OK_FILE = 'credit_v0/tests/test_files/ok_size_2.jpg'
    PATH_TO_OVERSIZE_FILE = 'credit_v0/tests/test_files/over_size_2.jpg'
    PATH_TO_NOT_CORRECT_FORMAT_FILE = 'credit_v0/tests/test_files/test_file.txt'
