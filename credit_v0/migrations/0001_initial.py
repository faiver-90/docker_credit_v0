    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand_car_info', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='credit_v0.carmake', verbose_name='Марка')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='credit_v0.carinfo')),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='credit_v0.clientpredata')),
                ('documents', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='credit_v0.documentsaleauto')),
                ('extra_insurance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='credit_v0.extrainsurance')),
                ('financing_conditions', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='credit_v0.financingconditions')),
            ],
            options={
                'verbose_name': 'Заявка',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='credit_v0.phonetype', verbose_name='Тип телефона'),
        ),
        migrations.CreateModel(
            name='Employment',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('document_file', models.FileField(upload_to=credit_v0.models.user_upload_to, verbose_name='Выбрать файл')),
                ('uploaded_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('document_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='credit_v0.userdocumenttype', verbose_name='Тип документа')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dealership_manager', models.ManyToManyField(blank=True, to='credit_v0.dealership', verbose_name='Дилерский центр')),
