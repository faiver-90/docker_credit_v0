...
from apps.questionnaire.services.constants import COLLECTIONS_OFFER_STATUSES
...
class GetByStatusOfferService:
    ...
    def __init__(self):
        ...
        self.offers_data = {status: [] for status in COLLECTIONS_OFFER_STATUSES}
    ...
    def get_offers_by_status(self, client_id) -> Dict[str, list]:
        ...
        for offer in offers:
            ...
            if status and status in COLLECTIONS_OFFER_STATUSES:  # Проверяем наличие статуса в константе
